...
public enum API {
    ...
    NASA("https://api.nasa.gov/planetary/apod?api_key=cwyO8Hefyzh1OuT6xMX5TcfD0YxVfg4HgpeUgQVL&start_date=2022-06-12&end_date=2022-06-14", new ExtratorDeConteudoDaNasa());
